            ...
            <div className="h-full flex flex-col items-center">
                <div className="flex flex-row w-2/3 gap-20 items-center py-28">
                    ...
                    <div className="flex flex-col gap-10">
                        <div className="text-6xl">{WebContent.aboutUsInfoOneTitle[language]}</div>
                        <p className="text-xl">{WebContent.aboutUsInfoOneText[language]}</p>
                    </div>
                </div>
                ...
                <div className="h-[25rem] flex justify-center items-center border-t-8 border-b-8 border-red-900 bg-center w-full bg-cover bg-[url('https://cdn.discordapp.com/attachments/989268383751106560/1130755685571899553/jakovid_a_dark_red_and_dark_green_themed_lively_English_classro_a9ea020d-fab6-44b0-a8d9-6b2a6e27301e.png')]">
                    <div className="bg-green-950 px-8 py-4 rounded-s-full rounded-e-full text-4xl cursor-pointer border-8 border-red-900 hover:text-green-950 hover:bg-[#E0D3AF]">{WebContent.aboutUsInfoButton[language]}</div>
                </div>

                <div className="flex flex-row w-2/3 gap-20 items-center py-28">
                    <div className="flex flex-col gap-10">
                        <div className="text-6xl">{WebContent.aboutUsInfoTwoTitle[language]}</div>
                        <p className="text-xl">{WebContent.aboutUsInfoTwoText[language]}</p>
                    </div>
