        ...
        <div className="bg-green-950/90 flex justify-center items-center">
            <div className="h-full flex flex-col items-center">
                <div className="flex flex-col px-8 lg:px-0 lg:flex-row lg:w-2/3 gap-8 lg:gap-10 items-center py-10 lg:py-28">
                    <img className=" lg:w-1/3 rounded-3xl border-8 border-red-900" src="https://cdn.discordapp.com/attachments/989268383751106560/1130755668555599902/jakovid_a_dark_red_and_dark_green_themed_lively_English_classro_a96abf72-14ef-4646-8f05-a6c6981af1b9.png"/>
                ...
                <div className="flex flex-col-reverse px-8 lg:px-0 lg:flex-row lg:w-2/3 gap-8 lg:gap-10 items-center py-10 lg:py-28">
                    ...
                    <img className=" lg:w-1/3 rounded-3xl border-8 border-red-900" src="https://cdn.discordapp.com/attachments/989268383751106560/1130756640430358599/jakovid_a_dark_red_and_dark_green_themed_lively_English_classro_7598e7a1-6e2b-4618-92aa-08489fc27cb5.png"/>
                </div>
            </div>
        </div>
    )
