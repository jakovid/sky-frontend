            ...
            <div className="flex flex-col gap-10 my-10 w-4/6 max-w-6xl">
                <div className="flex w-full gap-10 bg-green-950 p-5 rounded-xl border-8 border-red-900">
                    ...
                    <div className="flex flex-col w-full items-center text-center gap-6 justify-center">
                        <h2 className="text-6xl flex flex-wrap leading-tight">Taught by Qualified Native English Speakers</h2>
                        <p className="text-xl">We believe that happy teachers are more productive and creative. 
                            We want our teachers to want to come and teach. Our teachers bring a high-energy 
                            approach to the classroom every day to make classes fly by. 
                            Every class is a unique experience.</p>
                    </div>
                </div>
                <div className="flex w-full gap-10 bg-green-950 p-5 rounded-xl border-8 border-red-900">
                    ...
                    <div className="flex flex-col w-full items-center text-center gap-6 justify-center">
                        <h2 className="text-6xl flex flex-wrap leading-tight">Engaging Academic Environment</h2>
                        <p className="text-xl">For 15 years, we've been about having fun while learning English. 
                        In order to have fun while learning, kids need to feel safe, confident and able to make a 
                        mistake and not worry about it. Our classes are small with multi-media in all of them.</p>
                    </div>
                </div>
                <div className="flex w-full gap-10 bg-green-950 p-5 rounded-xl border-8 border-red-900">
                    ...
                    <div className="flex flex-col w-full items-center gap-6 justify-center text-center">
                        <h2 className="text-6xl flex flex-wrap leading-tight">Custom and Relevant Class Content</h2>
                        <p className="text-xl">Back in 2008, we believed that the English books used in Taiwanese 
                        classrooms were outdated, irrelevant and boring. So, we decided to create our own Sky books. 
                        (Phonics, Reading, Grammar)</p>
                    </div>
                </div>
            </div>
        </div>
